# azure_app.py - Azure-ready FastAPI application
...
async def azure_health():
    """Azure-specific health check for load balancer."""
    return {"status": "healthy"}

@app.get("/azure/ready")
async def azure_ready():
    """Azure readiness probe."""
    return {"ready": agent is not None and VECTORSTORE_PATH.exists()}
